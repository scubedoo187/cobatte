...
if($w == 'a')
    $result_url = G5_SKIN_URL.'/board/mypage/qaview.php?qa_id='.$qa_id.$qstr;
else if($w == 'u' && $write['qa_type'])
    $result_url = G5_SKIN_URL.'/board/mypage/qaview.php?qa_id='.$write['qa_parent'].$qstr;
else
    $result_url = G5_SKIN_URL.'/board/mypage/qalist.php'.preg_replace('/^&amp;/', '?', $qstr);
