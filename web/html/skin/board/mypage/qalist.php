...
if ($qaconfig['qa_category']) {
    $category_href = G5_SKIN_URL.'/board/mypage/qalist.php';
...
if(is_file($skin_file)) {
    ...
    for($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        $list[$i]['view_href'] = G5_SKIN_URL.'/board/mypage/qaview.php?qa_id='.$row['qa_id'].$qstr;
    ...
    $list_href = G5_SKIN_URL.'/board/mypage/qalist.php';
